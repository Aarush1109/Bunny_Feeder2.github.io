...
function preload()
{
  ...
  _1star = loadAnimation("one_star.png");
  _2star = loadAnimation("stars.png");
...
function setup() 
{
  ...
  //scoreboard
  scoreboard=createSprite(50,30,30,30);
  scoreboard.scale= 0.2;
  scoreboard.addAnimation("empty",emptystar);
  scoreboard.addAnimation("one",_1star);
  scoreboard.addAnimation("two",_2star);
  scoreboard.changeAnimation("empty");
